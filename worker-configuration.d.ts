/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd05005bc6502e4c1e9e8aef2530a5eb)
// Runtime types generated with workerd@1.20260526.1 2026-05-01 nodejs_compat
interface __BaseEnv_Env {
    ...
    AI_LOG_LLM: string;
    AI_LOG_LLM_CONTENT: string;
    AI_LOG_LLM_CHUNKS: string;
}
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_SIGNUP_EMAIL_DOMAINS" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "BETTER_AUTH_URL" | "ADMIN_EMAILS" | "CONFIG_ENCRYPTION_KEY" | "TAVILY_API_KEY" | "AI_LOG_LLM" | "AI_LOG_LLM_CONTENT" | "AI_LOG_LLM_CHUNKS">> { }
}
