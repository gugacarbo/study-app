...
import {
	...
	ToolGroupRoot,
	ToolGroupTrigger,
} from "@/features/ai/components/assistant-ui/tool-group";
...
type ThreadComponents = {
	...
	ComposerAction?: ComponentType | undefined;
...
const ThreadRoot: FC<{ isEmpty: boolean; showComposer: boolean }> = ({
	isEmpty,
	showComposer,
}) => {
...
const Composer: FC = () => {
	const { Composer: ComposerComponent = DefaultComposer } = useContext(
		ThreadComponentsContext,
	);
	return <ComposerComponent />;
};

const DefaultComposer: FC = () => {
	return (
...
const ComposerAction: FC = () => {
	const { ComposerAction: ComposerActionComponent = DefaultComposerAction } =
		useContext(ThreadComponentsContext);
	return <ComposerActionComponent />;
};

const DefaultComposerAction: FC = () => {
	return (
