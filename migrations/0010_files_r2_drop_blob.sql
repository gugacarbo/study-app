...
INSERT INTO `__new_files`("id", "exam_id", "name", "r2_key", "mime_type", "size", "created_at") SELECT "id", "exam_id", "name", "r2_key", "mime_type", "size", "created_at" FROM `files`;--> statement-breakpoint
