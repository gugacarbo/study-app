...
| Aspecto                  | Conteúdo                                                                                                                                                                                                                                                                                                         |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **📖 Resposta Ideal**    | Cliente/Servidor: Centralizado. O cliente solicita recursos e o servidor processa e responde. Publish/Subscribe: Baseado em eventos e intermediado por um _Broker_. Publicadores enviam mensagens para tópicos, e assinantes recebem mensagens dos tópicos nos quais se inscreveram. É assíncrono e desacoplado. |
