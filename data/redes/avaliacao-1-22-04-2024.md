...
| Aspecto                 | Conteúdo                                                                                                                                                                                                                                                                                              |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **📖 Resposta Ideal**    | Como no Wi-Fi não é possível detectar colisões facilmente, usa-se o CA (*Collision Avoidance*). A estação escuta o meio; se estiver livre, aguarda um tempo e transmite. Se estiver ocupado, realiza um "backoff" (espera um tempo aleatório) antes de tentar novamente. Exige ACKs para confirmação. |
...
| **📝 Avaliação**         | Parcialmente correta. Faltou detalhar a necessidade do uso de ACKs e o mecanismo exato de recuo exponencial (*backoff*), mas a essência do "escutar para evitar" está presente.                                                                                                                       |
